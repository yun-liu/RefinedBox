...
3. Download the precomputed edge boxes proposals for the VOC2007 dataset [here](https://github.com/yun-liu/RefinedBox/releases/download/v1.0/VOC2007_EdgeBoxes_NMS_0.90_data.tar.gz) and put the extracted files in the `data` folder.
